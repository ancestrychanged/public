...
| `[0:00:10.69-0:00:10.92]` | `left;` | same as [0:00:10.20-0:00:10.47] | `[ ]` repeat the exact animation from the 'left;' scene at 0:00:10.20; you can copy and paste the keyframes for all relevant objects `[ ]` consider swapping the face decal to a new expression to keep it fresh. |
...
| `[0:00:23.80-0:00:24.30]` | `four,` | character palm shows 4; text '4' pops out | `[ ]` change character2's pose to show '4' (you may need to get creative with a vfx counter for this); `[ ]` model a 3d text '4'; animate it popping into view |
